...
class AplazamePayLater extends AbstractMethod
{
    const PAYMENT_METHOD_CODE = 'aplazame_payment_pay_later';
    ...
    /**
     * @var \Aplazame\Payment\Gateway\Config\ConfigPayLater
     */
    private $aplazameConfig;

    public function __construct(
        AplazameClient $aplazameClient,
        \Aplazame\Payment\Gateway\Config\ConfigPayLater $aplazameConfig,
